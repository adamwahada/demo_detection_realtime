...
class KalmanFilter:
    ...
    def initiate(self, measurement):
        ...
        Returns:
            mean: Mean vector (8 dimensional) of the new track. Unobserved velocities are
                 initialized to 0 mean.
            covariance: Covariance matrix (8x8 dimensional) of the new track. Unobserved
                       velocities are initialized to high uncertainty.
        """
    ...
    def predict(self, mean, covariance):
        ...
        Args:
            ...
            covariance: The 8x8 dimensional covariance matrix of the object state at the
                       previous time step.
        
        Returns:
            mean: The mean vector of the predicted state.
            covariance: The covariance matrix of the predicted state.
        """
        std_pos = [
    ...
    def project(self, mean, covariance):
        ...
        Returns:
            mean: The projected mean.
            covariance: The projected covariance.
        """
        std = [
            self._std_weight_position * mean[3],
            self._std_weight_position * mean[3],
    ...
    def multi_predict(self, mean, covariance):
        ...
        Args:
            ...
            covariance: The Nx8x8 dimensional covariance matrices of the object states at the
                       previous time step.
        
        Returns:
            mean: The mean matrix of the predicted states.
            covariance: The covariance matrices of the predicted states.
        """
        std_pos = [
            self._std_weight_position * mean[:, 3],
            self._std_weight_position * mean[:, 3],
    ...
    def update(self, mean, covariance, measurement):
        ...
        Returns:
            mean: The measurement-corrected state distribution.
            covariance: The measurement-corrected state covariance.
        """
    ...
    def gating_distance(self, mean, covariance, measurements, only_position=False):
        ...
        Args:
            ...
            measurements: An Nx4 dimensional matrix of N measurements.
            only_position: If True, distance computation is done with respect to the bounding
                          box center position only.
        
        Returns:
            An array of length N, where the i-th element contains the squared Mahalanobis
